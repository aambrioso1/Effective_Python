...
#  You can define your own helper functions with complex logic in TestCase subclasses.
#  A custom test can be designed with a fail method that can clarify which assumptions aren't met.
